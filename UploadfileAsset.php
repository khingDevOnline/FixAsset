...
if (isset($_POST['Assetid'])) {
  ...
  //  $stmt->bindParam(':AssetFile', $AssetFile, PDO::PARAM_STR);
    ...
    $stmt = $conn->prepare("INSERT INTO  FixAsset_FileUp ( AssetId, AssetFile, AssetUpday, AssetUserUp )
    VALUES ('$AssetId',:AssetFile, '$AssetUpday','$AssetUserUp')");
    $stmt->bindParam(':AssetFile', $AssetFile, PDO::PARAM_STR);
    ...
    //เงื่อนไขตรวจสอบการเพิ่มข้อมูล
            if($stmt){
              /*  echo '<script>
                ...
                <a href="ShowDataAssetDept.php"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button> </a>
                 </div>';
