          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title">  ข้อมูลแบบแจ้งการดำเนินสัญญาที่ถูกเช็คเเล้ว </h5>                            
                            <table class="table datatable">
                                    ...
                                    <tbody>
                                    <?php
                                        $stmt = $conn->prepare("SELECT  * FROM  FixContact WHERE StatusChecked ='W' ");
                                        $stmt->execute();
                                        $rs = $stmt->fetchAll();
                                        foreach($rs as $row) {
                                   ...
                                   <td> <a href="ContactDetial.php?id=<?php echo $row['idContact'];  ?>" class="btn btn-primary"> <i class="bi bi-clipboard-data"></i> รายละเอียด </a> </td>
