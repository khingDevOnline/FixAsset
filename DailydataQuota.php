          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <br>
                ...
                <div class="col-md-4">
                  <label for="validationDefaultUsername" class="form-label">ชื่อผู้รับเรื่อง</label>
                ...
                <label for="validationDefault03" class="form-label">ค้นหาจาก</label>               
                  <select class="form-control" aria-label="Default select example" name="Gserach">
                      ...
                      <option value="2">ชื่อผู้รับเรื่อง</option>                   
                    </select>                           
                </div>
                ...
                <input type="hidden" name="action" value="action" id="">
                 ...
                 <a href="LandSecurities.php"  rel="noopener noreferrer"> <button class="btn btn-outline-primary" type="button"> <i class="bx bxs-image-add"></i> เพิ่มใบคำร้อง</button> </a>
