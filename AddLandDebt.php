    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <main id="main" class="main">
            ...
            <div class="card-body">
              <h5 class="card-title"> หลักทรัพย์ที่ดิน </h5>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  ...
                  <label for="inputText" class="col-sm-1 col-form-label">ประเภทที่ดิน * </label>
                  <div class="col-sm-2">
                  ...
                  <label for="inputText" class="col-sm-1 col-form-label">ผู้ถือกรรมสิทธิ์ * </label>
                  <div class="col-sm-2">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-1 col-form-label">จำนวนไร่ *</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="Cusappday" required >
                  </div>

                  <label for="inputText" class="col-sm-1 col-form-label">ติดภาระหนี้สิน *</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="Cusappmount" required >
                  </div>

                  <label for="inputText" class="col-sm-1 col-form-label">ยอดหนี้สิน *</label>
                  <div class="col-sm-3">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-1 col-form-label">รายละเอียดอื่นๆ</label>
                  <div class="col-sm-6">
